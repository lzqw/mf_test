...
def main():
    ...
    p.add_argument('--enable_ttc_lateral_gate',action=argparse.BooleanOptionalAction,default=True); p.add_argument('--ttc_lateral_gate',type=float,default=1.8); p.add_argument('--ttc_front_min_longitudinal',type=float,default=0.0); p.add_argument('--ttc_front_max_longitudinal',type=float,default=30.0); p.add_argument('--cbf_builtin_policy_name',choices=['idm','lane_change','trajectory_idm','expert','fallback_lane','fallback_obstacle_avoid'],default='idm'); p.add_argument('--cbf_obstacle_radius',type=float,default=1.35); p.add_argument('--cbf_safe_distance',type=float,default=1.35); p.add_argument('--cbf_activation_distance',type=float,default=20.0); p.add_argument('--cbf_ttc_activation_threshold',type=float,default=5.0); p.add_argument('--cbf_min_closing_speed',type=float,default=0.05)
    ...
    if args.filter_type == "mpc_cbf":
        ...
        cbf_builtin_cfg = CBFBuiltinFilterConfig(
            ...
            enable_ttc_lateral_gate=args.enable_ttc_lateral_gate,ttc_lateral_gate=args.ttc_lateral_gate,ttc_front_min_longitudinal=args.ttc_front_min_longitudinal,ttc_front_max_longitudinal=args.ttc_front_max_longitudinal,
        )
