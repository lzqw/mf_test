...
def parse_args():
 ...
 p.add_argument('--fallback_pass_side',choices=['left','right'],default='left'); p.add_argument('--fallback_avoid_distance',type=float,default=18.0); p.add_argument('--fallback_max_steer',type=float,default=0.45); p.add_argument('--fallback_min_steer',type=float,default=0.12); p.add_argument('--fallback_target_speed',type=float,default=3.0); p.add_argument('--fallback_speed_kp',type=float,default=0.25); p.add_argument('--fallback_obstacle_lateral_gate',type=float,default=4.5); p.add_argument('--fallback_obstacle_front_min',type=float,default=-1.0); p.add_argument('--fallback_obstacle_front_max',type=float,default=20.0);
 p.add_argument('--enable_road_edge_guard',action=argparse.BooleanOptionalAction,default=True); p.add_argument('--road_edge_max_abs_lateral',type=float,default=5.0); p.add_argument('--road_edge_margin',type=float,default=0.35); p.add_argument('--road_edge_soft_margin',type=float,default=0.80); p.add_argument('--road_edge_cost_weight',type=float,default=10.0); p.add_argument('--road_edge_use_start_lane',action=argparse.BooleanOptionalAction,default=True); p.add_argument('--road_edge_lane_width_fallback',type=float,default=3.7); p.add_argument('--road_edge_num_allowed_lane_changes',type=int,default=1); p.add_argument('--road_edge_block_raw',action=argparse.BooleanOptionalAction,default=True); p.add_argument('--enable_ttc_lateral_gate',action=argparse.BooleanOptionalAction,default=True); p.add_argument('--ttc_lateral_gate',type=float,default=1.8); p.add_argument('--ttc_front_min_longitudinal',type=float,default=0.0); p.add_argument('--ttc_front_max_longitudinal',type=float,default=30.0); p.add_argument('--enable_cbf_lateral_gate',action=argparse.BooleanOptionalAction,default=True); p.add_argument('--cbf_lateral_gate',type=float,default=2.0); p.add_argument('--cbf_front_min_longitudinal',type=float,default=-1.0); p.add_argument('--cbf_front_max_longitudinal',type=float,default=30.0); p.add_argument('--cbf_close_distance_margin',type=float,default=0.3); p.add_argument('--builtin_policy_name',choices=['idm','lane_change','trajectory_idm','expert','fallback_lane','fallback_obstacle_avoid'],default='idm'); p.add_argument('--require_approaching',action=argparse.BooleanOptionalAction,default=True); p.add_argument('--preserve_raw_accel_if_positive',action=argparse.BooleanOptionalAction,default=False)
 return p.parse_args()
...
def main():
 a=parse_args(); fallback_pass_side_value = -1.0 if a.fallback_pass_side == 'left' else 1.0; cfg=CBFBuiltinFilterConfig(dt=a.dt,horizon=a.horizon,obstacle_radius=a.cbf_obstacle_radius,safe_distance=a.cbf_safe_distance,cbf_activation_distance=a.cbf_activation_distance,ttc_activation_threshold=a.ttc_activation_threshold,min_closing_speed=a.min_closing_speed,cbf_h_margin=a.cbf_h_margin,cbf_min_margin=a.cbf_min_margin,require_approaching=a.require_approaching,steer_limit=a.steer_limit,throttle_limit=a.throttle_limit,brake_limit=a.brake_limit,max_steer_angle=a.max_steer_angle,max_dsteer=a.max_dsteer,max_daccel=a.max_daccel,builtin_policy_name=a.builtin_policy_name,builtin_action_scale=a.builtin_action_scale,blend_with_raw=a.blend_with_raw,correction_min_throttle=a.correction_min_throttle,preserve_raw_accel_if_positive=a.preserve_raw_accel_if_positive,enable_ttc_lateral_gate=a.enable_ttc_lateral_gate,ttc_lateral_gate=a.ttc_lateral_gate,ttc_front_min_longitudinal=a.ttc_front_min_longitudinal,ttc_front_max_longitudinal=a.ttc_front_max_longitudinal,enable_cbf_lateral_gate=a.enable_cbf_lateral_gate,cbf_lateral_gate=a.cbf_lateral_gate,cbf_front_min_longitudinal=a.cbf_front_min_longitudinal,cbf_front_max_longitudinal=a.cbf_front_max_longitudinal,cbf_close_distance_margin=a.cbf_close_distance_margin,fallback_pass_side=fallback_pass_side_value,fallback_avoid_distance=a.fallback_avoid_distance,fallback_max_steer=a.fallback_max_steer,fallback_min_steer=a.fallback_min_steer,fallback_target_speed=a.fallback_target_speed,fallback_speed_kp=a.fallback_speed_kp,fallback_obstacle_lateral_gate=a.fallback_obstacle_lateral_gate,fallback_obstacle_front_min=a.fallback_obstacle_front_min,fallback_obstacle_front_max=a.fallback_obstacle_front_max,enable_road_edge_guard=a.enable_road_edge_guard,road_edge_max_abs_lateral=a.road_edge_max_abs_lateral,road_edge_margin=a.road_edge_margin,road_edge_soft_margin=a.road_edge_soft_margin,road_edge_cost_weight=a.road_edge_cost_weight,road_edge_use_start_lane=a.road_edge_use_start_lane,road_edge_lane_width_fallback=a.road_edge_lane_width_fallback,road_edge_num_allowed_lane_changes=a.road_edge_num_allowed_lane_changes,road_edge_block_raw=a.road_edge_block_raw)
